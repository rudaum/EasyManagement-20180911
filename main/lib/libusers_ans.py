...
class UserHtmlPage(object):
    ...
    def buildHtmlPage(self, dict):
        ...
        self.append_code('<div class="btn btn-group">')
        # Creating the Report Button
        self.append_code('<a href="#Report" class="btn btn-primary" role="button">Report</a>')

        # Creating the dropdown Button with user filter
        self.append_code('<div class="dropdown">')
        self.append_code('<button class="btn btn-primary dropdown-toggle" role="button" '
                         'data-toggle="dropdown">Users ')
        self.append_code('<span class="caret"></span>')
        self.append_code('</button>')
        self.append_code('<ul class="dropdown-menu">')
        self.append_code('<input class="form-control" id="userFilter" type="text" ' 
                         'placeholder="Filter...">')
        self.append_code('</input>')
